...
import org.chronotics.talaria.websocket.jetty.jettylistener.EachMQToEachSession;
...
public class TestEachMQToEachSession {

    private static final Logger logger =
            LoggerFactory.getLogger(TestEachMQToEachSession.class);
